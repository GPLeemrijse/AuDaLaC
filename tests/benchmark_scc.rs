    ...
    vec![
        (
            ...
            vec![
                ...
                ("tests/benchmarks/SCC/testcases/random_scc_27500_35652.init", vec!["-N".to_string(), "NodeSet=27500".to_string()], 27500 + 35652),
                // ("tests/benchmarks/SCC/testcases/random_scc_50000_64814.init", vec!["-N".to_string(), "NodeSet=50000".to_string()], 50000 + 64814),
                ("tests/benchmarks/SCC/testcases/random_scc_275000_357961.init", vec!["-N".to_string(), "NodeSet=275000".to_string()], 275000 + 357961),
                // ("tests/benchmarks/SCC/testcases/random_scc_500000_649534.init", vec!["-N".to_string(), "NodeSet=500000".to_string()], 500000 + 649534),
                ("tests/benchmarks/SCC/testcases/random_scc_2750000_3574304.init", vec!["-N".to_string(), "NodeSet=2750000".to_string()], 2750000 + 3574304),
    ...
    vec![
        (
            ...
            vec![
                ...
                ("tests/benchmarks/SCC/testcases/random_col_27500_35652.init", Vec::new(), 27500 + 35652),
                // ("tests/benchmarks/SCC/testcases/random_col_50000_64814.init", Vec::new(), 50000 + 64814),
                ("tests/benchmarks/SCC/testcases/random_col_275000_357961.init", Vec::new(), 275000 + 357961),
                // ("tests/benchmarks/SCC/testcases/random_col_500000_649534.init", Vec::new(), 500000 + 649534),
                ("tests/benchmarks/SCC/testcases/random_col_2750000_3574304.init", Vec::new(), 2750000 + 3574304),
